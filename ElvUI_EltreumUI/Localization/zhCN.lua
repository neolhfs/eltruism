...
L["Choose a type of cursor by clicking it"] = "点击来选择一个样式的鼠标指针"
L["Currently selected cursor: "] = "目前选择的指针:"
L["Type 1"] = "样式 1"
L["Type 2"] = "样式 2"
L["Type 3"] = "样式 3"
L["Type 4"] = "样式 4"
...
L["Type 9"] = "样式 9"
L["Type 10"] = "样式 10"
L["The Cursor will use this type as its texture"] = "鼠标指针会使用这个样式来作为其材质"
L["Requires a Reload"] = "需要重载界面"
L["Class Colored Casts"] = "职业颜色施法圈"
L["Use Class Colors for Cast"] = "施法圈使用职业颜色"
L["Custom Color Cast"] = "自定义施法圈颜色"
L["Class Colored GCD"] = "职业颜色GCD"
L["Use Class Colors for GCD"] = "GCD使用职业颜色"
L["Custom Color GCD"] = "自定义GCD颜色"
L["Class Colored Combat"] = "职业颜色战斗信息"
L["Use Class Colors for Cursor"] = "鼠标指针使用职业颜色"
L["Custom Color Combat"] = "自定义战斗信息颜色"
L["Cast Radius (Default: 25)"] = "施法圈半径(默认：25)"
L["Cast Thickness (Default: 5)"] = "施法圈厚度(默认：5)"
L["Set the radius of the cast cursor"] = "为鼠标指针施法圈设置半径"
L["GCD Radius (Default: 20)"] = "GCD圈半径(默认：20)"
L["Set the radius of the gcd cursor"] = "为鼠标指针GCD圈设置半径"
L["GCD Thickness (Default: 5)"] = "GCD圈厚度(默认：5)"
L["Set the thickness of the gcd cursor"] = "为鼠标指针GCD圈设置厚度"
L["Combat Cursor Radius (Default: 15)"] = "鼠标指针战斗圈半径(默认：15)"
L["Set the radius of the combat cursor"] = "为鼠标指针战斗圈设置半径"
L["Combat Cursor Thickness (Default: 5)"] = "鼠标指针战斗圈厚度(默认：5)"
L["Set the thickness of the combat cursor"] = "为鼠标指针战斗圈设置厚度"
L["Aura Filters"] = "光环过滤器"
L["For Shadowlands, import aura filters by copying the code below and going into Profiles > Import Profile."] = "暗影国度中，复制下方的代码然后去 配置文件>导入配置文件 来导入光环过滤器。"
L["Setup Aura Filters to show all"] = "让光环过滤器显示所有光环"
L["All Player Buffs"] = "玩家身上全部的Buff"
L["Set filters to show more buffs on Player"] = "让光环过滤器显示玩家身上更多的Buff"
L["All Player Debuffs"] = "玩家全部的Debuff"
L["Set filters to show more debuffs on Player"] = "让光环过滤器显示玩家身上更多的Debuff"
L["All Target Debuffs"] = "目标身上全部的Debuff"
L["Set filters to show more debuffs on Target"] = "让光环过滤器显示目标身上更多的Debuff"
L["All Target Buffs"] = "目标全部的Buff"
L["Set filters to show more buffs on Target"] = "让光环过滤器显示目标身上更多的Buff"
L["All Focus Buffs"] = "焦点单位全部的Buff"
L["Set filters to show more buffs on Focus"] = "让光环过滤器显示焦点身上更多的Buff"
L["All Focus Debuffs"] = "焦点单位全部的Debuff"
L["Set filters to show more debuffs on Focus"] = "让光环过滤器显示焦点身上更多的Debuff"
L["All Boss Buffs"] = "Boss全部的Buff"
L["Set filters to show more buffs on Boss"] = "让光环过滤器显示Boss身上更多的Buff"
L["All Boss Debuffs"] = "Boss全部的Debuff"
L["Set filters to show more debuffs on Boss"] = "让光环过滤器显示Boss身上更多的Debuff"
L["All Nameplate Buffs"] = "姓名版上全部的Buff"
L["Set filters to show more buffs on Nameplates"] = "让光环过滤器显示姓名版上更多的Buff"
L["All Nameplate Debuffs"] = "姓名版上全部的Debuff"
L["Set filters to show more debuffs on Nameplates"] = "让光环过滤器显示姓名版上更多的Debuff"
L["Setup Aura Filters to be Eltruism defaults"] = "将光环过滤器设为Eltruism默认模式"
L["Eltruism Player Buffs"] = "Eltruism 玩家Buff"
L["Set filters to be Eltruism defaults on Player"] = "将玩家的光环过滤器设为Eltruism默认"
L["Eltruism Player Debuffs"] = "Eltruism 玩家Debuff"
L["Eltruism Target Debuffs"] = "Eltruism 目标Debuff"
L["Set filters to be Eltruism defaults on Target"] = "将目标的光环过滤器设为Eltruism默认"
L["Eltruism Target Buffs"] = "Eltruism 目标Buff"
L["Eltruism Focus Buffs"] = "Eltruism 焦点Buff"
L["Set filters to be Eltruism defaults on Focus"] = "将焦点的光环过滤器设为Eltruism默认"
L["Eltruism Focus Debuffs"] = "Eltruism 焦点Debuff"
L["Eltruism Boss Buffs"] = "Eltruism 首领Buff"
L["Set filters to be Eltruism defaults on Boss"] = "将Boss的光环过滤器设为Eltruism默认"
L["Eltruism Boss Debuffs"] = "Eltruism 首领Debuff"
L["Eltruism Nameplate Buffs"] = "Eltruism 姓名版Buff"
...
L["Add Sockets and Enchants to the Character Panel"] = "在角色面板显示插槽和附魔"
L["Item Levels"] = "物品等级"
